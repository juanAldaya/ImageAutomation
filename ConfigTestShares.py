...
def addShareToTestPrep(testPrep):
    
    prepShareName = "Win11Test$"
    ...
    addSharePrep =  'New-SmbShare -Name ' + prepShareName + " -Path " + testPrep
...
def addShareToTestProv(testPrep):

    provShareName = "APPTest_11$"
    grantedPermissionGroups = "DIR\\IE.ISS.ISA.LATAM.HSA.TS, DIR\\IE.ISS.ISA.LATAM.Argentina.RO.Servers, DIR\\AMPC.Admin, DIR\\mpc.latam.app, DIR\\IE.ISS.ISA.LATAM.HSA.Deployment.ADS"


    provPath =  testPrep + "\\'$OEM'$\\ProvisioningPackage\\Deploy"
